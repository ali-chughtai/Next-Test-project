...
export default function SingleAppointment({ appointment, onBack }: { appointment: Appointment; onBack: () => void }) {
    return (
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            <div className="flex justify-between items-start mb-6">
              <h1 className="text-3xl font-bold text-gray-800">{appointment.name}</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              ...
              <div className="space-y-4">
                <h2 className="text-xl font-semibold text-gray-700 border-b pb-2">Academic Information</h2>
                <div className="space-y-3">
                  <div>
                  ...
                  <div>
                    <span className="font-medium text-gray-600">Last Degree:</span>
                  ...
                  <div>
                    <span className="font-medium text-gray-600">Scholarship Country:</span>
                    <p className="text-gray-800">{appointment.scholarshipCountry}</p>
                  </div>
                  <div>
                    <span className="font-medium text-gray-600">Level Applying For:</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <div>
                    <span className="font-medium text-gray-600">Appointment Day:</span>
              ...
              <div className="space-y-4">
                <h2 className="text-xl font-semibold text-gray-700 border-b pb-2">Confirmation Receipt</h2>
                {appointment.confirmationReceipt ? (
                  ...
                  <p className="text-red-500 text-center py-8">No receipt available</p>
                )}
              </div>
            </div>
          </div>

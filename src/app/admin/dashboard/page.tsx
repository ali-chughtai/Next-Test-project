...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4">
      {!selectedAppointment ?  <div className="max-w-7xl mx-auto">
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-2 text-sm mb-3">
                    <div>
                      ...
                      <p className="font-medium text-black">{appointment.city}</p>
                    </div>
                    <div>
                      <span className="text-gray-500">University:</span>
                      <p className="font-medium text-black">{appointment.university}</p>
                    </div>
                    <div>
                      <span className="text-gray-500">Country:</span>
                      <p className="font-medium text-black">{appointment.scholarshipCountry}</p>
                    </div>
                    <div>
                      <span className="text-gray-500">Appointment Day:</span>
                      <p className="font-medium text-black">{appointment.appointment_day}</p>
                    </div>
                  </div>
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Scholarship Country</th>
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Level</th>
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Contact</th>
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Email</th>
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Appointment Day</th>
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          {appointment.confirmationReceipt ? (
                            ...
                            <span className="text-red-500 text-xs">No receipt</span>
                          )}
                        </td>
                      </tr>
                    ))}
      ...
      {selectedAppointment && <SingleAppointment
            ...
            onBack={() => setSelectedAppointment(undefined)} 
          />}
      </div>}
    </div>
  );
